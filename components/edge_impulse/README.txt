...
# Edge Impulse library for ADMM-orthosis

This is a C++ library that lets you run the impulse for "ADMM-orthosis" (https://studio.edgeimpulse.com/studio/1053353) on any device. It consists of the Edge Impulse inferencing SDK - with implementations of both processing and learning blocks - and your model. You will need to include this library in your project to run your impulse locally.
